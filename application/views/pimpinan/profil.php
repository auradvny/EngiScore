...
<div class="content">
    <div class="container-fluid">
        <div class="calonpimpinan-update">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Update Biodata: <span style="text-transform: uppercase;font-weight: bold;"><?= $user['nama']; ?></span></h3>
                </div>
                <div class="card-body">
                    <form name="update" action="<?php echo base_url('pimpinan/updatebiodata'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group required">
                                    <label class="control-label" for="nip">NIP Pimpinan</label>
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="image">Profile Pimpinan</label>
                                ...
                                <div class="form-group required">
                                    <label class="control-label" for="tgl_lahir">Tanggal Lahir Pimpinan (Tahun-Bulan-Tanggal)</label>
